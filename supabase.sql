...
create policy "public read approved submissions" on public.project_submissions
...
create policy "public read approved project files" on storage.objects
for select
using (
...
create policy "public upload project files" on storage.objects
for insert to anon, authenticated
...
create policy "admins manage project storage" on storage.objects
